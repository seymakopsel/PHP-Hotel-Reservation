 ...
 */
final class Version20200616105759 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE setting CHANGE smtpserver smtpserver VARCHAR(75) DEFAULT NULL, CHANGE smtpemail smtpemail VARCHAR(75) DEFAULT NULL, CHANGE smtppassword smtppassword VARCHAR(75) DEFAULT NULL, CHANGE twitter twitter VARCHAR(75) DEFAULT NULL');
    }
